         ...
         {!isAdmin&&(<div className="mb-8">
          ...
          {isAdmin && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
              {adminStats.map((stat) => (
                <div key={stat.title} className="bg-white rounded-xl shadow-sm p-6 flex items-center space-x-4 border border-gray-100 hover:shadow-md transition-shadow">
          ...
          {isAdmin && (
            <div className="mt-8">
              <h3 className="text-xl font-bold mb-4 text-gray-800">Analytics Overview</h3>
