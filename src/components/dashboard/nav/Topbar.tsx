    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
          ...
          <div className="px-4 hover:text-[#3aafef] py-3 border-b border-gray-100 hover:bg-gray-50 ">
            <Link
              to="/"
              className="text-sm font-semibold text-gray-900 hover:text-[#3aafef]"
            >
              <p>Home</p>
            </Link>
          </div>
          <button
            className="w-full cursor-pointer text-left px-4 py-3 text-sm text-red-600 hover:bg-gray-50 rounded-b-lg"
            onClick={onLogout}
          >
            Logout
          </button>
